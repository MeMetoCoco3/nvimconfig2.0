local quotes = {
        "I rather have a bag full of 8s than a mind full of 10s.",
				...
				"It has been said that computers are basically people made out of metal or, conversely, people are computers made out of flesh and blood. However, once we get close to computers, we see that they are basically machines that follow very specifix and primitive instructions.",
			}
